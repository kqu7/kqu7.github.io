...
THREE.CanvasRenderer = function(parameters) {
    ...
    this.render = function(scene, camera) {
        ...
        if (background && background.isColor) {
            // var grd = _context.createLinearGradient(0, 0, 200, 0);
        ...
        _context.setTransform(
            _viewportWidth / _canvasWidth,
            0,
            0, -_viewportHeight / _canvasHeight,
            _viewportX,
                    ...
                    if (geometry.index !== null) {
                        ...
                        if (groups.length > 0) {
                            for (var g = 0; g < groups.length; g++) {
                                ...
                                for (
                                    var i = group.start, l = group.start + group.count; i < l; i += 3
                                ) {
...
function init() {
    ...
    var PI2 = Math.PI * 2;
    /* note: this is the place to change the color of dots */
    var material = new THREE.SpriteCanvasMaterial({
        color: 0xb5b7bb,
